...
var swe_svg = d3.select("#sweden_ageplot")
  .append("svg")
    .attr("width", swe_width + swe_margin.left + swe_margin.right)
    .attr("height", swe_height + swe_margin.top + swe_margin.bottom)
  .append("g")
    .attr("transform",
...
d3.csv("data/sweden3.csv", function(data) {
    ...
    swe_svg.append("g")
      .attr("transform", "translate(0," + swe_height + ")")
