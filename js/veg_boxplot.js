...
// append the veg_bp_svg object to the body of the page
var veg_bp_svg = d3.select("#veg_boxplot")
  .append("svg")
...
d3.csv("data/veg_full_data.csv", rowConverter, function(data) {
  ...
  var y = d3.scaleLinear()
    .domain([0,600])
    .range([bp_height, 30])
  veg_bp_svg.append("g").call(d3.axisLeft(y))
