...
// append the fat_bp_svg object to the body of the page
var fat_bp_svg = d3.select("#fat_boxplot")
  .append("svg")
...
d3.csv("data/fat_full_data.csv", rowConverter, function(data) {
...
//   // Compute quartiles, median, inter quantile range min and max --> these info are then used to draw the box.
  ...
  var y = d3.scaleLinear()
    .domain([0,1000])
    .range([bp_height, 30])
  fat_bp_svg.append("g").call(d3.axisLeft(y))
